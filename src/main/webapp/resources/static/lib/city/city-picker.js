                ...
                .each(function () {
                    ...
                    if (item) {
                        text += ($(this).hasClass('province') ? '' : '/') + '<span class="select-item" data-count="' +
                            type + '" data-code="' + item.code + '">' + item.address;
                        if (type == "province"){
                            text += '<input type="hidden" name="provinceCode" value="' + item.code + '">';
                            text += '<input type="hidden" name="provinceName" value="' + item.address + '">';
                        }
                        if (type == "city"){
                            text += '<input type="hidden" name="cityCode" value="' + item.code + '">';
                            text += '<input type="hidden" name="cityName" value="' + item.address + '">';
                        }
                        if (type == "district"){
                            text += '<input type="hidden" name="areaCode" value="' + item.code + '">';
                            text += '<input type="hidden" name="areaName" value="' + item.address + '">';
                        }
                        text += '</span>';
                    }
                });
